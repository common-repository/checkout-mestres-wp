        ...
        <div class="mwpbody">
            <div class="mwpbrcolone">
                ...
                <div class="mwp-sections">
                    <ul>
                        <?php
                        // Sanitizar $_GET['type'] e $_SERVER['REQUEST_URI']
                        $page = isset($_GET['type']) ? sanitize_text_field(wp_unslash($_GET['type'])) : 'pagamentos.simulador-parcelas';
                        ...
                        foreach ($mwp_pages_admin as $mwp_pages_key => $mwp_pages_value) {
                            ...
                            <li class="<?php echo esc_html($active); ?> <?php echo esc_html($mwp_pages_key); ?> box_menu">
                                <a href="admin.php?page=cwmp_admin_parcelamento&type=<?php echo esc_html($mwp_pages_key); ?>">
            ...
            <div class="mwpbrcoltwo">
                <div class="mwpsectioncontent">
                    <div class="">
						...
						$custom_pages = array('pagamentos.discounts-method-payment-add', 'pagamentos.discounts-method-payment-edit');
                        ...
                        if (isset($_GET['type'])) {
                            ...
                            include __DIR__ . "/html/pagamentos.simulador-parcelas.php";
                        }
                        ?>
                    </div>
                </div>
