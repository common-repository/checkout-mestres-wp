			...
			if(get_option('cwmp_license_active')==true){
				$args = array(
					'box'=>array(
						...
						'115'=>array(
							'title'=>__( 'Documentação', 'checkout-mestres-wp'),
							'description'=>__( 'Desabilite o banner da documentação', 'checkout-mestres-wp'),
							'button'=>array(
								'id'=>'view_docs',
							),
						),
