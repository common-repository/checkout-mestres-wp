			<div class="mwp-box">
				<div class="col col-1">
					<h3><?php echo esc_html__( 'Pre-formatted templates', 'checkout-mestres-wp'); ?></h3>
					<p><?php echo esc_html__( 'Choose a theme pre-formatted by our team.', 'checkout-mestres-wp'); ?></p>
					<a href="#" class="action cwmp_template_pre"><?php echo esc_html__( 'Change template', 'checkout-mestres-wp'); ?></a>
				</div>
				<div class="col col-2">
					<strong><?php echo esc_html__( 'Template', 'checkout-mestres-wp'); ?></strong>
					<span><?php echo esc_html__( 'Choose your template', 'checkout-mestres-wp'); ?></span>
					<select name="cwmp-checkout-template-pre" id="cwmp-checkout-template-pre" class="input-150">
						<option value=""><?php echo esc_html__( 'Select', 'checkout-mestres-wp'); ?></option>
						<option value="padrao" <?php if(get_option('cwmp-checkout-template-pre')=="red"){ echo "selected"; } ?>><?php echo esc_html__( 'Padrão', 'checkout-mestres-wp'); ?></option>
						<option value="red" <?php if(get_option('cwmp-checkout-template-pre')=="red"){ echo "selected"; } ?>><?php echo esc_html__( 'Red', 'checkout-mestres-wp'); ?></option>
						<option value="blue" <?php if(get_option('cwmp-checkout-template-pre')=="blue"){ echo "selected"; } ?>><?php echo esc_html__( 'Blue', 'checkout-mestres-wp'); ?></option>
						<option value="green" <?php if(get_option('cwmp-checkout-template-pre')=="green"){ echo "selected"; } ?>><?php echo esc_html__( 'Green', 'checkout-mestres-wp'); ?></option>
					</select>
				</div>
			</div>
			<?php
