        ...
        <div class="mwpbody">
            <div class="mwpbrcolone">
                ...
                <div class="mwp-sections">
                    <ul>
                        <?php
                        $page = isset($_GET['type']) ? sanitize_text_field(wp_unslash($_GET['type'])) : 'licensa.checkout';
                        ...
                        foreach ($mwp_pages_admin as $mwp_pages_key => $mwp_pages_value) {
                            ...
                            <li class="<?php echo esc_html($active); ?> <?php echo esc_html($mwp_pages_key); ?> box_menu">
                                <a href="admin.php?page=cwmp_admin_licensas&type=<?php echo esc_html($mwp_pages_key); ?>">
            ...
            <div class="mwpbrcoltwo">
                <div class="mwpsectioncontent">
                    <div class="">
                        <?php 
                        $allowed_pages = array('licensa.checkout');
                        if (isset($_GET['type'])) {
                            $page_type = sanitize_file_name(wp_unslash($_GET['type']));
                            if (in_array($page_type, $allowed_pages, true)) {
                                include "html/" . $page_type . ".php";
                            } else {
                                echo '<p>' . esc_html__('Invalid page type.', 'checkout-mestres-wp') . '</p>';
                            }
                        } else {
                            include "html/licensa.checkout.php";
                        }
                        ?>
                    </div>
                </div>
